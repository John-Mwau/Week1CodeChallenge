...
function payYeeCalculator(){//Calculates employee Payee
let payYee;
switch(true){
...
function NHIFcalcultor(){//Assign NHIF contribution based on the provided range.
let NHIF;
switch(true){
...
const NSSFCalculator=()=>{//calculate employee NSSF contribution based on the provided percentage.
    let NSSF;
    return NSSF=0.06*employeeSalary;
}
let netPay=employeeSalary-(payYeeCalculator()+NHIFcalcultor()+NSSFCalculator());//calculates employees Net Pay.
console.log(netPay);
